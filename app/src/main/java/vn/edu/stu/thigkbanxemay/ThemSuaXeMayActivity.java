            ...
            public void onClick(View view) {
                try {
                    if (TextUtils.isEmpty(txtten.getText()) || TextUtils.isEmpty(spnphanloai.getSelectedItem().toString()) || TextUtils.isEmpty(txtgia.getText())
                        ...
                        Toast.makeText(ThemSuaXeMayActivity.this, R.string.txt_error_empty, Toast.LENGTH_SHORT).show();
                        ...
                        if (chon == null) {
                            ...
                            Toast.makeText(ThemSuaXeMayActivity.this, R.string.txt_message_LuuThanhCong, Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(ThemSuaXeMayActivity.this, R.string.txt_message_Dasuaxong, Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE_GALLERY) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, R.string.txt_message_BanChuaCapQuyenCamera, Toast.LENGTH_SHORT).show();
            }
            return;
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.mnuTRangChu:
                Intent intent0 = new Intent(ThemSuaXeMayActivity.this, MainActivity.class);
                startActivity(intent0);
                break;
            case R.id.mnuQuanLyPhanLoai:
                Intent intent3 = new Intent(ThemSuaXeMayActivity.this, QuanLyPhanLoaiActivity.class);
                startActivity(intent3);
            case R.id.mnuPhanLoai:
                Intent intent1 = new Intent(ThemSuaXeMayActivity.this, PhanLoaiActivity.class);
                startActivity(intent1);
                break;
            case R.id.mnuThongTinUngDung:
                Intent intent2 = new Intent(ThemSuaXeMayActivity.this, AboutActivity.class);
